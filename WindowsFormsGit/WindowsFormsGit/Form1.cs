...
namespace WindowsFormsGit
{
    public partial class Form1 : Form
    {
        ...
        private void Zhylchuk_KN31_2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(anecdot, "window Жильчук В.Ю.", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
        }
    }
}
